...
public class Favorites extends com.tuit.ar.activities.timeline.Status {
	...
	protected com.tuit.ar.models.timeline.Status getTimeline() {
		return com.tuit.ar.models.timeline.Favorites.getInstance(Twitter.getInstance().getDefaultAccount());
	}
}
